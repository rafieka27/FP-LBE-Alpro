...
func Seed(db *gorm.DB) {
	...
	users := []models.User{
		{NRP: "DOSEN001", Name: "Dr. Rizky Januar Akbar", Email: "dosen@its.ac.id", PasswordHash: string(password), Role: models.RoleDosen},
		{NRP: "ASISTEN001", Name: "Asisten Dosen Demo", Email: "asisten@its.ac.id", PasswordHash: string(password), Role: models.RoleAsisten},
