...
export default function Login() {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      localStorage.setItem("eduportal-email", data.user.email);
      localStorage.setItem("eduportal-role", data.user.role);
      localStorage.setItem("eduportal-name", data.user.name);
